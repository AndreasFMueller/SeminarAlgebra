...
In einem Computer kann man aber nur abzählbar unendlich viele Zahlen
exakt darstellen.
...
$\alpha$ erweitert.
Die weiteren Rechnungen finden daher in $K=\mathbb{Q}(\alpha)$ statt.
...
unabhängig.
Das bedeutet aber nur, dass man eine Potenz von $\pi$ niemals wird
...
Sie ermöglichen, dass man die Ableitung beliebig komplizierter Ausdrücke
...
Um eine solche zu finden ist die Definition des Riemann-Integrals
