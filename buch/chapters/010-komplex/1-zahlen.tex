...
\]
in der gaussschen Zahlenebene als auch als $2\times 2$-Matrix
beschrieben werden.
...
Ist $a+bi$ eine komplexe Zahl, dann gibt es einen Winkel $\varphi$ derart,
dass 
\[
a + bi
=
...
\]
Der Winkel $\varphi$ heisst das \emph{Argument} der komplexen Zahl.
