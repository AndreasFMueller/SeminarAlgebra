...
Urbildmenge und Bildmenge, es ist sehr einfach zu entscheiden,
...
Die Christoffel-Transformation ist nur bis auf Integrationskonstante
definiert.
Ebenso muss man bei der Berechnung der Potenzen $(w-a_k)^{1-\alpha k/\pi}$
im Nenner einen geeignete Fortsetzung der Potenzfunktion wählen, damit
...
Die Forderung $f'(z)=e^{i\varphi}>0$ bedeutet, dass $\varphi=0$ sein muss,
