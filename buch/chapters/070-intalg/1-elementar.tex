...
Eine \emph{Deriviation} in einem Funktionenkörper $K$ ist eine 
...
\[
\frac{\partial}{\partial a},\qquad
\frac{\partial}{\partial b},\qquad
\frac{\partial}{\partial c},\qquad
\frac{\partial}{\partial x},\qquad
\frac{\partial}{\partial y}\qquad\text{oder}
\frac{d}{dx},\qquad\text{und}\qquad
\frac{d}{dz},
\]
...
Elementes $f\in K$.
Die Deriviationseigenschaft liefert
\begin{align*}
D(f^n)
&=
...
Der Funktionenkörper $F$ mit der Deriviation $D$ ist daher ein
...
\begin{definition}[Exponential- und Logarithmusfunktione]
