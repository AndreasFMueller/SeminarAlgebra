...
\end{equation}
wobei die $c_i$ die verschiedenen, möglicherweise komplexen Zahlen $c$ sind
...
$c=c_i=c_k$ haben, können die beiden Terme zusammengefasst werden zu
eine mit $v(z) = v_i(z)v_k(z)$.
Es ist nämlich
\[
cv(z)
=
