...
\end{equation}
mit quadratischen Nennern berechnen.
Dies ist mit wohlbekannten Methoden der klassischen Analysis 
nötig, wir geben hier nur die Resultate an, die man zum Beispiel
...
Höheren Nennerpotenzen $m>1$ können mit der folgenden Rekursionsformel
reduziert werden:
\begin{align}
\int 
...
+\frac{i}{2}\log (\zeta-i)
\qquad\text{mit }
\zeta=\frac{2z+\beta}{\!\sqrt{4\gamma-\beta^2}}
\]
möglich.
...
tatsächlich solche Linearfaktoren sind.
