...
Es ist klar, dass dazu mindestens Polynome und rationale Funktionen
einer Variablen gehören sollen.
Für diese Funktionen sind vollständige Methoden zur Berechnung von
Ableitungen und Stammfunktionen vor.
...
das Auftreten komplexer Funktionen nicht mehr verhindern, denn die
...
Kapitel~\ref{chapter:holomoprh} studiert.
Es stellt sich heraus, dass Differenzierbarkeit eine sehr starke
Einschränkung ist.

Ebenfalls zu den ältesten Kandidationfunktionen gehörten die
...
Stammfunktion in geschlossener Form zu finden.
Das Liouville-Prinzip macht zwar eine Aussage über die Existenz einer
Stammfunktion in geschlossener Form, um diese zu finden, ist jedoch
mehr nötig.
...
Moderne Computeralgebrasysteme verstehen diese Integrale und sind damit
in der Lage, auch solche Integrale auszuwerten
und gegebenenfalls in Stammfunktionen auch mit solchen wohlbekannten
speziellen Funktionen darzustellen.
...
ihre $\varepsilon$-$\delta$-Technik entwickelt hat.
...
Lange Zeit trat diese aber in den Hintergrund, weil sich 
...
\index{Mathematica}%
des Risch-Algorithmus zur Verfügung steht und im die symbolische Berechnung
