...
Weg $\gamma$, der vom Punkt $A$ ausgehend zunächst dem äusseren Randkreis
...
Die Funktion ist im Inneren des Weges $\gamma$ überall holomorph,
...
\begin{proof}
Zunächst halten wir fest, dass die Formeln
\eqref{buch:analytisch:laurent:eqn:laurentkoeffizienten}
für die Koeffizienten sich als Integrale über nur einen
der Randkreise ausdrücken lassen.
Zum Beispiel gilt 
\[
\oint_{\gamma_2}
f(z)\, (z-z_0)^{k-1}\,dz
...
0
\]
für $k\ge 1$, weil der Punkt $z_0$ ausserhalb der Kurve $\gamma_2$ ist
und $(z-z_0)^{k-1}$ im Inneren der Kurve holomorph ist.
Es folgt, dass
\[
b_k
=
...
\,dz
\]
trägt für $k\ge 0$ nur der äussere Randkreis etwas bei.
Dazu muss man mittels eine Koordinatentransformation $\zeta = 1/(z-z_0)$
aus dem inneren Randkreis den äusseren Randkreis machen.
Dann folgt wie vorhin, dass der innere Randkreis nichts beiträgt,
man kann ihn daher weglassen.
Nach Rücktransformation bleibt dann nur der Beitrag des inneren 
Randkreises.
