...
Nach dem Homotpiesatz~\ref{buch:integration:satz:homotopie} von
Abschnitt~\ref{buch:integration:wegintegral:subsection:homotopie}
...
und einen zusammenziehbaren Weg $\gamma$, der den Punkt $z_0\in U$
...
\eqref{buch:integration:eqn:residuensatz1}
