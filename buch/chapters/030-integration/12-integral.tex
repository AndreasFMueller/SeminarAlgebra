...
\]
geschrieben.
\index{iogamma@$\oint_\gamma$}%
\index{oigamma@$\oint_\gamma$}%
\end{definition}
...
Seien $\gamma_1$ und $\gamma_2$ Wege in $U\subset\mathbb{C}$ so, dass
der Endpunkt von $\gamma_1$ der Anfangspunkt von $\gamma_2$ ist, also
\[
\gamma_1(1)
=
\gamma_2(0).
