...
% buchberger:
%
Computeralgebrassysteme werden heute routinemässig verwendet, um
...
\emph{Natanael Fässler}
\index{Natanael Fässler}%
\index{Fässler, Natanael}%
...
werden.
Für eine quaratische Funktion eines Polynoms höheren Grades funktioniert
dies nicht mehr.
