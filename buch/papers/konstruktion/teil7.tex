...
Sie macht den Satz robust gegenüber affinen Transformationen
...
Abbildung~\ref{komplex:figure:pdn-quadrat} zeigt den Spezialfall $n = 4$,
in dem aus einem beliebigen Viereck in zwei Schritten ein Quadrat entsteht.

\input{papers/konstruktion/pdn-quadrat.tex}
...
findet sich im Kapitel~\ref{chapter:moebius} sowie in \cite{komplex:needham} und \cite{komplex:schwerdtfeger}.
