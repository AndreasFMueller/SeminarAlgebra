...
(gemäss Definition~\eqref{komplex:eq:schwerpunkte}),
...
\end{equation}
Die drei Klammerausdrücke sind genau dieselbe quadratische Form in $d$:
\begin{align*}
1 - 2d + d (1 + d)
&=
1 - 2d + d + d^2
...
Dies bedeutet, dass das Resultat unter affinen Transformationen ---
