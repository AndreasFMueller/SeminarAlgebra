...
\begin{subequations}
    \begin{align}
        ...
        &=
        \frac{j\pi R^2}{2}
        \underbrace{\left(\cos(2\vartheta) + j \sin(2\vartheta)\right)}_{e^{2j\vartheta}}\\
        &=
...
Der Bogen verschwindet zwar nicht,
aber sein Einfluss auf den gesamten Integralbetrag,
an dem wir interessiert sind, schon.

\begin{figure}
    \centering
    \resizebox{0.45\textwidth}{!}{\input{papers/fresnel/images/drehung-beispielbild.tex}\unskip}
    \caption{
        Integrationswege in der komplexen Ebene mit Radius $R$
