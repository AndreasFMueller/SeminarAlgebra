...
Die gemessene Amplitude $\psi_1$ nach einer Distanz $r$ kann mit
\begin{equation}
    \psi_1
    =
    \psi \cdot \frac{e^{j(\omega t -kr)}}{r}
\end{equation}
und den Definitionen
\begin{itemize}
    \item 
    $\psi$ als ursprüngliche Amplitude
    \item 
...
\begin{equation}
    \psi_h
    =
    \psi \cdot \frac{\text{exp}\left(j(\omega t -kr)\right)}{r}
    \approx
    \psi \cdot \frac{\text{exp}\left(j\omega t -jk\left(d+\frac{h^2}{2d}\right)\right)}{d}.
...
\begin{equation}
    ...
    \approx
    \psi \cdot \text{exp}\left(-jk\left(d+\frac{h^2}{2d}\right)\right).
