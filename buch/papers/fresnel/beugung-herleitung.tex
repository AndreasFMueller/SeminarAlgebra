...
die Beugung von Signalen an einer Knife-Edge gebraucht.
...
\psi_{rx}
=
\rho_{\psi_0} \int_{h_{\text{edge}}}^{\infty} \mathrm{e}^{-jk\left(\frac{h^2}{2d}\right)} dh
=
...
\end{equation}
und für $L_{\unit{\decibel}}$ die Umrechnung
\[
L_{\unit{\decibel}} (v)
=
10 \cdot \log_{10}L(v)
...
Soll nun der Beugungsverlust zwischen Sender und Empfänger mit dazwischenliegender Knife-Edge wie in Abbildung~\ref{fresnel:knife-edge-abb} berechnet
