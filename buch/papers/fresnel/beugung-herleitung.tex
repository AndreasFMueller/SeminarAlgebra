...
\end{equation}
dargestellt werden. Über die Superposition der verschiedenen Höhen folgt
\begin{equation}
    \psi_{rx}
    =
...
\end{align*}
führt.
Das Integral ähnelt $C$ aus der Formel~\eqref{fresnel:integral-C-S-beispiel} und kann über die Substitution
\[
h
\text{ zu }
t(h)
