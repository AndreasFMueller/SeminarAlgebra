...
Wir erfahren zum Beispiel, dass das Volumen einer $1$-dimensionalen Einheitskugel $V_1(1) = 2$ sein muss. Intuitiv ist das, vertretbar, wie \ref{gamma-fig:1-dim-sphere} zeigt.
...
Dies hat die interessante Konsequenz, dass $\Gamma(1.5) = \frac{1}{2} \pi$, weil sie $\sqrt{\pi}$ im Zähler ausgleichen muss.
