...
Mithilfe der $\Gamma$-Funktion können wir nun die Formel zur Berechnung des Kugelvolumens erweitern
und alle Kugelvolumen mit
\begin{equation}
\label{gamma-eq:n-sphere-volume}
    V_n(r) = \frac{\pi^{n/2}}{\Gamma(\frac{n}{2}+1)}  r^n
\end{equation}
berechnen, also auch solche ungerader Dimensionen.
Wir erfahren zum Beispiel, dass das Volumen einer $1$-dimensionalen Einheitskugel $V_1(1) = 2$ sein muss. Intuitiv ist das sinnvoll, wie Abb.~\ref{gamma-fig:1-dim-sphere} zeigt.
...
Dieses Resultat hat die interessante Konsequenz, dass $\Gamma(1.5) = \frac{1}{2} \sqrt{\pi}$, weil sie $\sqrt{\pi}$ im Zähler ausgleichen muss.
