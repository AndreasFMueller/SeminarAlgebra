...
Mit Hilfe des Bohr-Mollerup-Theorems (\ref{gamma:section:BMT}) kann nachgewiesen werden, dass es sich bei
\begin{equation}
...
Auch hier gilt $\Gamma_{\text{Lanczos}}(z) = \Gamma(z)$, wobei auf die Herleitung verzichtet wird.