...
\end{equation}
kann man auch die logarithmische Konvexität (\ref{gamma-eq:bm-3}) von $\Gamma_{\text{Integral}}(z)$ beweisen. 
...
Da nur eine endliche Summe mit $N$ Gliedern ausgewertet wird, ermöglicht das Verfahren eine genaue und zugleich effiziente Berechnung der $\Gamma$-Funktion. Auch hier gilt $\Gamma_{\text{Lanczos}}(z) = \Gamma(z)$, wobei auf die Herleitung verzichtet wird.