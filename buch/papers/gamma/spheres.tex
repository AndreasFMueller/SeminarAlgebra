...
\label{gamma-eq:n-sphere-constant-2}
    \begin{split}
    I_{n-1} I_{n-2} &= \left(\frac{n-1}{n} \cdot \frac{n-3}{n-2} \cdot \ldots \cdot \frac{3}{4} \cdot I_1\right) \cdot \left(\frac{n-2}{n-1} \cdot \frac{n-4}{n-2} \cdot \ldots \cdot \frac{2}{3} \cdot I_0\right) \\
