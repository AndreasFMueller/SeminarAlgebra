...
bestimmtes $x$ die möglichen $y$-Werte gemäss Ungleichung 
\eqref{gamma-eq:pythagoras-y} eingeschränkt sind und für ein bestimmtes $x$ und $y$ dann
der maximale Wert für $z$ gemäss Ungleichung \eqref{gamma-eq:pythagoras-3d} genommen wird. 
