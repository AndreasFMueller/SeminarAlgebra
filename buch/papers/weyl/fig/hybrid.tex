...
\begin{tikzpicture}[>=latex,thick,
    ...
    sub/.style={font=\scriptsize,gray!50!black}]
%
...
\node[font=\small,gray!40!black] at (4.95,2.3) {Übergabe};
\node[font=\footnotesize,gray!50!black] at (4.95,1.5) {Mittelpunkte};
%
...
\begin{scope}[xshift=6cm]
  ...
  \node[root] at (2.3,1.9) {};
  \node[font=\footnotesize,red!80!black] at (2.65,1.95) {$z_*$};
  % Newton-Iterationspunkte (Konvergenz auf z*)
  \node[newtonpt,label={[font=\tiny,above=-1pt]:$z_0$}] (z0) at (1.4,2.7) {};
  \node[newtonpt,label={[font=\tiny,above=-1pt]:$z_1$}] (z1) at (1.8,2.35) {};
  \node[newtonpt,label={[font=\tiny,above=-1pt]:$z_2$}] (z2) at (2.15,2.05) {};
...
Nullstelle $z_*$ konvergiert. So vereinen sich die globale Zuverlässigkeit des
