...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{papers/jordan/images/beweis_kreis.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{papers/jordan/images/polygon_halbebene.pdf}
...
Einfache geschlossene Kurven können jedoch auch nicht-konvexe Formen annehmen, was den Beweis für konvexe Polygone erneut unzureichend macht, um den Satz von Jordan im Generellen zu beweisen.
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{papers/jordan/images/strahlenparitaet.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{papers/jordan/images/triangulierung.pdf}
...
\begin{satz}[Identitätssatz für reell-analytische Funktionen]
    Sei $f: U \subset \mathbb{R}^n \to \mathbb{R}$ eine nicht verschwindende reell-analytische Funktion auf einer zusammenhängenden Menge $U$.
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{papers/jordan/images/tubulare_umgebung.pdf}
...
\begin{proof}[Beweis des Lemmas der tubulären Umgebung]
    Sei $\gamma$ eine reell-analytische Kurve in der Ebene $\mathbb{R}^2$ und $\Phi$ die durch $\Phi(t,s) = \gamma(t) + s \cdot n(t)$ definierte Abbildung. 
    Die Jacobi-Determinante von $\Phi$ in $(t,0)$ ist $||\gamma'(t)|| \neq 0$. 
    Nach dem Satz über die Umkehrfunktion ist $\Phi$ lokal ein Diffeomorphismus um jeden Punkt $(t,0)$. 
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{papers/jordan/images/tangentenwindungszahl.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{papers/jordan/images/umlaufzahl.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{papers/jordan/images/spitzen_ecken.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{papers/jordan/images/koch_schneeflocke.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{papers/jordan/images/polygonale_approximation.pdf}
