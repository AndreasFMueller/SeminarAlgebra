...
Dieser Umstand -- keine Nullstellen, aber Pole -- ist entscheidend:
...
\frac{1}{\Gamma(z)}
=
z \cdot e^{\gamma z} \cdot \prod_{n=1}^{\infty} \left(1 + \frac{z}{n}\right) e^{-z/n},
\end{equation}
...
liefert die \textbf{Reflexionsformel von Euler}:
\begin{equation}
...
Die Beweisstruktur lässt sich in drei Schritte gliedern:
...
oder der Produktdarstellungen), dass $f$ beschränkt und damit nach dem
...
von $1/\Gamma$ zwei Seiten derselben Münze sind --
beide sind Manifestationen des Weierstraß-Produktsatzes auf denselben
...
\textbf{Signalverarbeitung und Regelungstechnik.}
...
Das Entwerfen von Filtern -- Tief-, Hoch-, Bandpassfilter -- ist direkt das Platzieren
...
Halbebene liegen -- eine Nullstellenbedingung im Sinne dieser Arbeit.

\textbf{Zahlentheorie und die Riemannsche Vermutung.}
...
Die Riemannsche Vermutung -- eines der großen offenen Probleme der Mathematik --
ist im Kern eine Aussage darüber, wo diese Nullstellen liegen.
...
\textbf{Quantenfeldtheorie und Regularisierung.}
...
\textbf{Spezielle Funktionen in der Mathematik.}
