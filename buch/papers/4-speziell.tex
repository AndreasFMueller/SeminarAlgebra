...
\index{Gian Cavegn}%
\index{Cavegn, Gian}%
Kapitel~\ref{chapter:bessel} gibt eine Einführung in die
Lösung der besselschen Differentialgleichung.
Sie illustriert die Ähnlichkeiten und Unterschiede zwischen
Bessel-Funktionen und trigonometrischen Funktionen und
zeigt auch die ursprüngliche Motivation Bessels, eine
\index{Bessel, Friedrich Wilhelm}%
Fourier-Entwicklung für die Lösung der Kepler-Gleichung der
\index{Kepler-Gleichung}%
Himmelsmechanik zu finden.
