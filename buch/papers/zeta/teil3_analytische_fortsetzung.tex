...
Die in Abschnitt 5.3 des Buches hergeleitete analytische Fortsetzung liefert für die Zeta-Funktion die sogenannte Funktionalgleichung, welche $\zeta(s)$ mit $\zeta(1-s)$ verbindet:
\[
\zeta(s) = 2^s \pi^{s-1} \sin\left(\frac{\pi s}{2}\right) \Gamma(1 - s)\,\zeta(1 - s).
\]
Diese Gleichung gilt für (fast) alle $s \in \mathbb{C}$ und liefert damit auch für negative $s$ einen wohldefinierten Wert von $\zeta(s)$, obwohl die ursprüngliche Reihe dort gar nicht konvergiert.
