...
Grundsätzlich wird in der Analytischen Fortsetzung einfach eine neue
Funktion konstruiert, die den selben Definitionsbereich wie die
ursprüngliche Funktion hat. Jedoch ist diese neue Funktion auch
ausserhalb dieses Bereichs definiert.

In der Anwendung auf die Riemannsche Zeta-Funktion kann eine solche
analytische Fortsetzung fast auf die gesamte komplexe Ebene angewendet
werden. Die einzige Ausnahme ist der Punkt bei s = 1.
...
Wenn man jedoch dann die Analytische Fortsetzung verwendet und die
Funktion anders darstellt durch eine Erweiterung des Terms, bekommt man
...
hat. So ist sie definiert für auch fast alle negativen Werte für s. 
