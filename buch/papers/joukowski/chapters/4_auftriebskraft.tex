...
\index{Druckgradient}%
\index{Schwerefeld}%
	Die Druckkräfte auf der Unterseite des Objektes sind daher grösser als auf der Oberseite,
...
\index{hydrostatischer Auftrieb}%
...
\index{Bernoulli-Prinzip}%
	Um den Druckgradienten zu bestimmen, muss bekannt sein, wie sich der Druck im Raum $p(z)$ verhält. Dies kann mit der \emph{Bernoulli-Gleichung}
...
\subsection{Grundlage der Auftriebskraft}
	...
	welches wir mit $\gamma$ bezeichnen,
	aufsummiert werden, woraus
	\begin{equation}
		F'
		=
	...
	Mithilfe der Multiplikation mit $i$ können wir ausdrücken,
...
\index{Widerstandskraft}%
	...
	\begin{align}
		...
		\\
		\intertext{	entsteht.
					Der konstante Teil $C$ kürzt sich durch die Integration um die geschlossene Kontur $\gamma$ heraus.
	...
	jedoch kann es eine quantitative Aussage zur Auftriebskraft $F'_y$ machen.
