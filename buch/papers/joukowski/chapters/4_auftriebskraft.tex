...
\subsection{Das Bernoulli-Prinzip}
	Um den Druckgradienten zu bestimmen, muss bekannt sein, wie sich der Druck im Raum verhält. Dies kann mit der Bernoulli-Gleichung
...
\subsection{Aus Anströmungsgeschwindigkeit wird Auftrieb}
	...
	Die rechte Seite dieses Ausdrucks enthält keinen Realteil, das bedeutet, dass es keine Kraftkomponente $F'_x$ hat.
