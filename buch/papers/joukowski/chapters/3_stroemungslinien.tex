...
\label{joukowski:sec:stroemungslinien}
	\subsection{Allgemeine Definition}
		...
		Für eine laminare Strömung in der Ebene gilt, dass die Geschwindigkeit $\vec{v}$ der Gradient einer Potentialfunktion $\varphi$ ist.
		...
		\[
			...
			0.
		\]
		Dies beschreibt die Situation einer sogenannter Potentialströmung.
