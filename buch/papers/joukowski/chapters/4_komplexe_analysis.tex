...
Um den Ausdruck~\eqref{joukowski:auftrieb:auftrieb} weiter aufzulösen, muss die oben eingesetzte Funktion $v(z)$ genauer untersucht werden.
...
Der Term $v_\infty r e^{i t} dt$ integriert gibt
...
Alle Terme $\displaystyle\frac{a_k}{r^{k-1} e^{(k-1) \cdot i t}}$ 
mit $k \in \mathbb{N}$, $k \geq 2$ 
gehen beim Grenzübergang des Radiuses $\displaystyle\lim_{r\to \infty}$ gegen $0$.
