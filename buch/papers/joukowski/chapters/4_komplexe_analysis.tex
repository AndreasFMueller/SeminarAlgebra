...
Bei der allgemeinen Form der Laurent-Reihe sind die Koeffizienten $a_k \in \mathbb{C}$, einzelne beschränken sich jedoch auf $a_k \in \mathbb{R}$, wie $a_0$.
...
Wir können die obige Gleichung~\eqref{joukowski:komplexe-analysis:laurent-reihe} in den Ausdruck
\[
	F'
	=
	-i \frac{\rho}{2} \cdot
...
\begin{align}
	...
	\\
	\intertext{schreiben.}
	\intertext{Somit lässt sich $2 v_\infty (-\frac{v_\infty}{2})$ ins zweite Integral verschieben.
	...
	\notag
	\\
	\intertext{durch einsetzen der Reihenentwicklung aus Gleichung ~\eqref{joukowski:komplexe-analysis:laurent-reihe} in}
	F'
	&= 
	-i \rho v_\infty \cdot
