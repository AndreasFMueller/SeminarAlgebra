...
dass die komplex konjugierte Geschwindigkeit $\overline{v(z)}$ als Laurent-Reihe der Form
...
Wir können die obige Reihenentwicklung~\eqref{joukowski:komplexe-analysis:laurent-reihe} in den Ausdruck
\[
	F'
	=
	-i \frac{\rho}{2} \cdot
	...
	dz
\]
von Gleichung~\eqref{joukowski:Auftriebskarft:Auftrieb1} einsetzen und ausmultiplizieren, wobei
\begin{align}
	F'
	&= 
	-i\frac{\rho}{2} \cdot 
...
\[
	...
	k \in [2, \infty)
\]
sind alle gleicher Art wie bei der Berechnung von $\Lambda$ in der Gleichung~\eqref{joukowski:komplexe-analysis:integral-e-hoch-kit},
...
Im Kapitel~\ref{joukowski:sec:stroemungslinien} Strömungslinien zeigen wir wie der Koeffizient $a_1$ für verschiedene Flügelprofile bestimmt werden kann.