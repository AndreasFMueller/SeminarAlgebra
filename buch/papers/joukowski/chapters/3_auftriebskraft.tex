...
\subsection{Zirkulation}
	...
	\end{equation}
	Es wird klar das die Zirkulation eine Zentrale Rolle spielt für die berechnung des Auftriebes. Im nächsten Kapitel Komplexe Analysis wird darauf eingegangen, wie aus der Form ~\eqref{joukowski:Auftriebskarft:Auftrieb2} der satz von Kutta-Joukowski gebildet werden kann.
