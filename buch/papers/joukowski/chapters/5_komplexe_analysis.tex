...
wobei aus Kapitel xx bekannt ist, dass
\begin{equation}
	\overline{v(z)}
	=
	\frac{df}{dz}
...
\[
	...
	dz
\]
wobei wir Ausdruck~\eqref{joukowski:komplexe-analysis:v-df-dz} einsetzen können und schliesslich erhalten wir die Gleichung
\begin{equation}
	F'_x - i F'_y
	=
	i \frac{\rho}{2} \cdot
