...
\subsubsection{Reibungsfreiheit}
	...
	nur bei einer reibungsfreier Strömung.
...
\input{papers/joukowski/fig/02_Voraussetzungen/fig_ball.tex}
	...
	Diese Vereinfachung ist nur möglich, da wir voraussetzen, dass die Strömung entlang dem ganzen Flügel identisch ist.
	...
	Somit haben wir ein Flügelprofil, welches von einem inkompressiblen, reibungsfreien Fluid lamiar umströmt wird.
	In grosser Entfernung besitzt die Strömung eine konstante Geschwindigkeit und einen konstanten Luftdruck,
	welche wir mit $v_\infty$, respektive $p_\infty$ bezeichnen.
	...
	In den folgenden Kapitel wird also die örtliche Abhängigkeit mit $z = x + iy$ beschrieben. Manchmal wird die vertikale Koordinate y auch mit $h(z)$ bezeichnet,
	weil sie zum Beispiel die Höhe eines fliegenden Flugzeugs darstellt."
