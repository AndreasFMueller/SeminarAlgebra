...
Sobald die Metllkugel angefassst wird,wandern die Ladungen auf die Versuchsperson, und da sie sich abstossen, entsteht eine kleine Kraft.
...
Dieses Kapitel gibt einen Überblick über die Grundbegriffe der Elektrostatik basierend auf dem Elektrotechnik-2-Skript im gleichnamigen Modul für Elektrotechniker, mit dem Ziel, auch für Nicht-Elektrotechniker gut verständlich zu sein. \cite{elektro:elt2-skript}.
...
Es kann jetzt auch gezeigt werden, wieso die beiden Felder senkrecht aufeinander stehen, eine ausführlichere Herleitung ist im Buch Functions of Complex Variables and Electrostatics von Francesco Lacava zu finden \cite{elektro:Lacava2022}.
...
Wenn zum Beispiel die Funktion $u$ des elektrischen Feldes bekannt ist, können wir
\begin{equation}
...
Durch Einsetzen in die Cauchy-Riemann-Gleichungen
\begin{equation}
	\begin{aligned}
	\nabla u \cdot \nabla v
	&= 
	\begin{pmatrix} \frac{\partial u}{\partial x} \\
...
\begin{equation}
		\nabla u \cdot\nabla v = 0.
\end{equation}
Das bedeutet, die Niveaulinien der beiden Funktionen $u(x,y)$ und $v(x,y)$ sind lokal senkrecht in ihren Schnittpunkten. Bei jedem Kreuzungspunkt gibt es einen 90 Grad Winkel zwischen den beiden Kurven.
