...
\section{Einleitung}
In diesem Kapitel wird beschrieben, was unter zweidimensionaler Elektrostatik verstanden wird, welche physikalischen und mathematischen Gesetze ihr zugrunde liegen und wie diese zur Berechnung und Darstellung elektrostatischer Felder eingesetzt werden können.
...
Blitze, klebende Styroporkügelchen und als Sonderbeispiel Van de Graaff Bandgeneratoren --- Grundlage für diese physikalischen Phänomene ist folgendes Prinzip:
...
Dieses Kapitel gibt einen Überblick über die Grundbegriffe der Elektrostatik basierend auf dem Elektrotechnik-2-Skript im gleichnamigen Modul für Elektrotechniker, mit dem Ziel, möglichst verständlich für Nicht-Elektrotechniker zu sein. \cite{elektro:elt2-skript}.
Elektrostatik enthält zwei grundlegende Begriffe: Elektrizität und Statik. 
...
Es geht nun darum, das $\vec{E}$-Feld auch mathematisch zu definieren.
...
In der Formel \eqref{elektro:equation:Potential} wird der Betrag des elektrostatischen Felds $\vec{E}$ als Variable verwendet, das an jedem Punkt von $\vec{E}$ auf das dort herrschende Potential geschlossen werden kann und umgekehrt. 
