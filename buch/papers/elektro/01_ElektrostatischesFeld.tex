...
\end{equation}
beschreibt die Kraft zwischen zwei ruhenden Punktladungen.
...
\begin{figure}
	...
	\caption[]{Die Äquipotentiallinien stehen in jedem Punkt senkrecht auf dem radialen elektrischen Feld.}
\end{figure}
...
Der Realteil u(x,y) ist das elektrische Feld und der Imaginärteil v(x,y) das Potentialfeld.
Beide Funktionen erfüllen die Cauchy-Riemann Gleichungen, die in Kapitel \ref{chapter:holomorph} eingeführt wurden und sind daher holomorph. 
