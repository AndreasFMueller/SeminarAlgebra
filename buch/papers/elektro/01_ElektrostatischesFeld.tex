...
In diesem Paper werden die Zusammenhänge zwischen Elektrostatik und Geometrie sichtbar gemacht. 
Die Geometrie wird auf zwei Dimensionen reduziert, was zu vielen Vereinfachungen führt.
Die deutlichste Vereinfachung ist, dass von den vier Maxwell-Gleichungen nur noch eine relevant ist, nämlich die Laplace Gleichung (\ref{elektro:equation:laplace}) für das Potential. 
...
Das Wort Elektrostatik enthält zwei grundlegende Begriffe: Elektrizität und Statik. 
