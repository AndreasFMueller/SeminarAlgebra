...
Anhand des Beispiels des Einheitskreises wird hier gezeigt wie von einem Potentialfeld $\varphi$ auf das elektrische Feld $\mathbf{E}$ geschlossen werden kann, wie im Abschnitt \ref{elektro:subsection:Laplace} behauptet wird.
