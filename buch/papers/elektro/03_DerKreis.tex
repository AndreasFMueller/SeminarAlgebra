...
\end{equation}
Da das Feld radial verläuft, kann das zuvor bestimmte elektrische Feld eingesetzt
werden:
\begin{equation}
\begin{aligned}
    \varphi(r)-\varphi(R)
...
Auch das in Abschnitt
\ref{elektro:subsection:Radialsymmetrie}
bestimmte Potential kann mit der komplexen Koordinate $z$ dargestellt werden.
