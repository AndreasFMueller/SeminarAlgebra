...
Im Abschnitt \ref{elektro:subsection:Einheitskreis-Beispiel} wurde gezeigt wie das Potentialfeld
\begin{equation}
...
Das elektrische Feld wird aufgeteilt in
\begin{equation}
\begin{aligned}
    \vec{E}
    &=
...
\end{aligned}
\end{equation}
wodurch sich die Feldanteile in $x$- und $y$-Richtung zu
...
\end{aligned}
\end{equation}
kann die Formel für $\mathcal{E}(z)$ in
\begin{equation}
	\boxed{
		\mathcal{E}(z)
		=
...
\end{equation}
resultiert das Analoge für das Potential. 
