...
Die komplexe Schreibweise wird verwendet, weil sich das konjugiert komplexe elektrische Feld $\vec{E}(z)$ dadurch als holomorphe Funktion der komplexen Koordinate $z$ darstellen und später mit komplexen Abbildungen transformieren lässt.