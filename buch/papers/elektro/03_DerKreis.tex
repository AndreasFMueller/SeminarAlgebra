...
Im Abschnitt \ref{elektro:subsection:Einheitskreis-Beispiel} wurde gezeigt wie das Potentialfeld $\varphi$ und das elektrische Feld $\mathbf{E}$ zusammenhängen.
...
Es braucht also einen Einstieg, durch den die Integralformel des elektrischen Feldes $\mathbf{E}$ gefunden werden kann. 
...
Anhand des Beispiels des Einheitskreises wird hier gezeigt wie von einem Potentialfeld $\varphi$ auf das elektrische Feld $\mathbf{E}$ geschlossen werden kann, wie im Abschnitt \ref{elektro:subsection:Einheitskreis-Beispiel} behauptet wird.

Unser Ausgangspunkt ist das elektrische Feld $\mathbf{E}$, das durch die Umformung zu zylindrischen Koordinaten auf $ E = \frac{\rho}{2\pi\varepsilon_0 r} \hat{r} $ vereinfacht werden kann.
...
Der Rückschluss vom Potentialfeld $\varphi$ auf das elektrische Feld $\mathbf{E}$ ist über die Laplace-Gleichung \ref{elektro:subsection:Laplace} möglich.
