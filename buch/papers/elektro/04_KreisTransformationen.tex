...
Dort sind das Potential und das elektrische Feld bereits bekannt (siehe Gleichung \eqref{elektro:equation:potential} und \eqref{elektro:equation:efeld}) und können anschliessend auf die ursprüngliche Geometrie zurückübertragen werden.
...
\end{equation}
wobei die Integrationsgrenze $w_0$ einfach ein gewählter Basispunkt ist.
