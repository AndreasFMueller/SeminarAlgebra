...
\end{equation*}
Was sich hinter dieser Formel verbirgt, ist nichts weiter als eine Komposition von einer Funktion $g$ mit sich selbst --- man erhält den nächsten Wert $x_{n + 1}$, indem man die Funktion $f$ auf den aktuellen Wert $x_n$ anwendet.
