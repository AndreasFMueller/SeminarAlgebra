...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{papers/julia/imgs/mandelbrot_julia_1.png}
    \caption{Mandelbrot-Menge bei $c=0$ und zugehörige Julia-Menge}
    \label{fig:mandelbrot_julia_1}
\end{figure}

Verschiebt man nun $c$ entlang der imaginären Achse, erhält man die Folge von Bildern in der Abbildung \ref{fig:mandelbrot_julia_2-5}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{papers/julia/imgs/mandelbrot_julia_2.png}
    \\[\smallskipamount]
    \includegraphics[width=0.85\textwidth]{papers/julia/imgs/mandelbrot_julia_3.png}
    \\[\smallskipamount]
    \includegraphics[width=0.85\textwidth]{papers/julia/imgs/mandelbrot_julia_4.png}
    \\[\smallskipamount]
    \includegraphics[width=0.85\textwidth]{papers/julia/imgs/mandelbrot_julia_5.png}
...
Bei den Bildern in Abbildung \ref{fig:mandelbrot_julia_2-5} ist die Mandelbrot-Menge schwarz dargestellt, alle eingefärbten Punkte gehören nicht mehr dazu.
...
Es soll an Funktionen der Art $f_c(z) = z^2 + c$ illustriert werden.
...
\begin{beispiel}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{papers/julia/imgs/mandelbrot_zoom.png}

        \caption{Mandelbrot-Menge bei $c_1 = 0.3626697754647427 + 0.6450273437137847i$}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.55\textwidth]{papers/julia/imgs/julia_zoom.png}

        \caption{Julia-Menge von $f(z) = z^2 + 0.3626697754647427 + 0.6450273437137847i$}
...
\begin{figure}
    ...
    \caption{Ein präperiodischer Zyklus}
...
\begin{figure}
    ...
    \caption{Punkt in der Mandelbrot-Menge}
    \label{fig:mosaik1}
\end{figure}
...
\begin{figure}
    ...
    \caption{Julia-Menge der Funktion $f(z) = z^2 - 0.47 + 0.45i$}
    \label{fig:mosaik2-4}
\end{figure}
...
\begin{figure}
    ...
    \caption{Mosaik der Mandelbrot-Menge}
    \label{fig:mosaik5}
\end{figure}
