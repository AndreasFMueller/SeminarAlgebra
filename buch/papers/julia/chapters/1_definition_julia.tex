...
Am Ende des Abschnitts \ref{arten_periodische_punkte} wurde festgestellt, dass die Funktion $f(z) = z^2$ einen abstossenden Fixpunkt bei $1$ hat.
Diese Funktion hat jedoch weitere abstossende, nicht-fixe periodische Punkte --- wenn $n \to \infty$, dann sogar unendlich viele.
...
Addiert man ein $\varepsilon$ mit $0 < |\varepsilon| << 1$ zu $z_e$, ist der Betrag entweder kleiner oder grösser als $1$.
...
Im vorherigen Beispiel bestand die Julia-Menge aus dem Rand des Einheitskreises, was bedeutet, dass der Rest der komplexen Ebene die Fatou-Menge darstellt.
