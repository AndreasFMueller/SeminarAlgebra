...
\begin{equation*}
    f(z) = z^2,
\end{equation*}
lassen sich diese Eigenschaften charakterisieren.
...
Diese beiden Startwerte scheinen Folgen anzuziehen.
...
Durch leichtes Verändern erhält man,
\begin{equation*}
...
\end{itemize}
Die beiden Begriffe \emph{stark anziehend} und \emph{anziehend} unterscheiden sich nur insofern, als dass Folgen die von \emph{stark anziehenden} Startwerten ausgehen, schneller wieder beim Startwert landen.
