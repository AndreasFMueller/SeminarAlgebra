...
Hier raus ergibt sich für jedes $z$ eine Folge komplexer Zahlen
\begin{equation}
...
Die Formel \eqref{taylor} für die Taylor-Reihe ignoriert die höheren Potenzen, da diese in den drei anderen Fällen nichts am Ausgang ändern.
...
Diese \emph{abstossenden} Punkte sind jedoch nicht deckungsgleich mit dem Einheitskreis, es gibt ``Lücken'' auf dem Einheitskreis, welche nicht zu dieser Punktemenge gehören (siehe Beispiel \ref{nicht_periodisch_julia}).
Allerdings ist die Distanz von jeder Lücke zu einem \emph{abstossenden} Punkt beliebig klein.
...
\begin{definition}
Im Allgemeinen lässt sich die Julia-Menge durch
\begin{equation*}
