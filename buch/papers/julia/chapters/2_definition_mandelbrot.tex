...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{papers/julia/imgs/mandelbrot2.png}
...
\subsection{Generalisierungen}
Die Mandelbrot-Menge lässt sich auf verschiedene Arten generalisieren.
In diesem Abschnitt werden einige davon beschrieben.

\subsubsection{Multibrot-Mengen}
Multibrot-Mengen entstehen, wenn man statt einer quadratischen Funktion, Polynome eines arbiträren Grades betrachtet
\begin{equation*}
    f_c(z) = z^d + c.
\end{equation*}
Beispiele davon sind in Abbildung \ref{fig:multibrot_mengen} dargestellt.
Dies kann weiter generalisiert werden, indem negative und rationale Zahlen als Exponent $d$ erlaubt werden.
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{papers/julia/imgs/multibrot.png}
