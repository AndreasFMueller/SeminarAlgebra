...
Beispiele für Punkte $c$ in verschiedenen Regionen sind in der Tabelle \ref{julia:beispiele_aussehen_mandel} dargestellt.
In der letzten Spalte ist jeweils $z_0$ inklusive der Folge beschrieben, die sich ergibt wenn die Funktion $z^2 + c$ mit dem zugehörigen $c$ iteriert wird.
...
\begin{table}[]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        Kardioide   & $-0.5$       & $1$              & \makecell{$\frac{1\pm\sqrt{3}}{2}$ \\ $\frac{1\pm\sqrt{3}}{2}$ \\ $\ldots$} \\
        \hline
        2-Knospe    & $-1$         & $2$              & \makecell{$0$                      \\ $-1$                     \\ $0$      \\ $\ldots$} \\
        \hline
        3-Knospe& $-\frac{1}{4} + \frac{3}{4}i$ & $3$ & \makecell{$0.215751 + 0.056067i$ \\ $-0.2066 + 0.7742i$ \\ $-0.8067 + 0.4301i$ \\ $0.215751 + 0.056067i$ \\ $\ldots$} \\
        \hline
        4-Knospe    & $-1.3$       & $4$              & \makecell{$-1.2996224637398612$ \\ $0.3890185482572668$ \\ $-1.1486645691118087$ \\ $0.019430292332817123$ \\ $-1.2996224637398612$ \\ $\ldots$} \\
        \hline
    \end{tabular}
    \caption{Beispielspunkte für den Aufbau der Mandelbrot-Menge}
