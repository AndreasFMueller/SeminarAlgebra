    ...
    \left\{
      ...
      \;\left|\;
        \begin{minipage}{7cm}\raggedright
          $\mathcal{S}$ ist ein Sudoku mit vorgegebenen Zahlen, welches eine Lösung besitzt, welches die bekannten Sudoku-Regeln erfüllt.
        \end{minipage}
      \right.
    \right\}
  \end{split}
...
\begin{equation}
  \begin{split}
    ...
    \left\{
      ...
      \;\left|\;
        \begin{minipage}{7cm}\raggedright
          $\mathcal{P}$ ist ein System von Polynomgleichungen, welches mindestens eine Lösung besitzt.
        \end{minipage}
      \right.
    \right\}
  \end{split}
...
ist die Frage $\text{P} \stackrel{?}{=} \text{NP}$, also ob die Komplexitätsklassen P und NP verschieden sind, was von den meisten Mathematikern vermutet wird.
