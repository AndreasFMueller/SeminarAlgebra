...
Das abgebildete $4\times4$ Sudoku
\footnote{
  Ein $4\times4$ Sudoku wird auch Shidoku genannt.
  Der Name Shidoku ist ein Wortspiel aus dem Wort Sudoku und dem Japanischen Zahlenwort TODO für die Zahl 4, welches "shi" ausgesprochen wird. % 四
}
ist eine kleinere Form des üblichen $9\times9$ Sudokus.
...
\end{figure}
Der Autor hat das Gleichungssystem mithilfe des Open-Source Computeralgebrasystems (CAS) \emph{Maxima} gelöst.
