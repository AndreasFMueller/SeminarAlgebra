...
Das Design wurde so ausgelegt, dass am Gelenkende, an dem die 
...
% Bilder von 3D-gedruckten Mechanismen
\begin{figure}[htbp]
    \centering
    ...
    \end{minipage}
    \caption{3D-gedruckter Perrolatz- und Peaucellier-Lipkin-Mechanismus.
    Bilder werden noch ergänzt\dots}
