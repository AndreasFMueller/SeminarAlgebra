...
\subsubsection{Peaucellier-Lipkin-Mechanismus}
...
Zusätzlich besitzt dieser Mechanismus die besondere Eigenschaft, dass
\begin{align}
    \overline{OB}\cdot\overline{OD} = \mathrm{const}.
    \label{eq:constant}
\end{align}
...
\subsubsection{Perrolatz-Mechanismus}
...
Ausserdem gilt
\begin{align}
    \overline{OE}\cdot\overline{OF}=\mathrm{const}.
    \label{eq:constant2}
\end{align}
Diese Eigenschaft lässt sich analog zum 
