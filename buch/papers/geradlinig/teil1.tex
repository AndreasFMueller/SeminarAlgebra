...
dargestellt oder auch in Abbildung~\ref{buch:integration:homologie:fig:paar}, bei welcher eine Lemniskate von Bernoulli entsteht.
...
die nicht im ursprünglichen Patent enthalten war 
und in Abbildung~\ref{fig:watts_parallel_link} dargestellt ist.
Diese Konstruktion wird als Parallelbewegungsmechanismus bezeichnet.
Sie war kompakter und für den praktischen Einsatz besser geeignet 
als die ursprüngliche Ausführung.
Aus diesem Grund setzte Watt sie auch in seiner Dampfmaschine ein,
die in Abbildung~\ref{fig:watts_engine} dargestellt ist.
\begin{figure}[htbp]
    \centering
