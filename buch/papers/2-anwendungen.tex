...
zweidimensionaler elektrostatischer Probleme ermöglichen, zeigen
\emph{Malenka Hossli}
...
Besonders schön kann man dort sehen, wie der gewohnten vektoriellen
Darstellung des elektrostatischen Feldes als Gradientenfeld eine komplexe
Darstellung gegenübergestellt werden kann, in der der Gradient zu einer
gewöhnlichen komplexen Ableitung wird.
...
Das Kapitel~\ref{chapter:pade} von \emph{Manuel Schmid} zeigt, wie dies geht.
\index{Manuel Schmid}%
\index{Schmid, Manuel}%
