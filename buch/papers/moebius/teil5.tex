...
\textbf{Einfachere Darstellung von Möbius-Transformationen}
...
\textbf{Verkettung von Transformationen:}
...
Diese Matrix kann nun wieder in die allgemeine Form der Möbius-Transformation eingesetzt werden:
\[
f(z) = \frac{az + b}{cz + d}.
\]

Daraus ergibt sich die zugehörige Transformation:
\[
f(z) =
\frac{2e^{i\pi/4} \cdot z + (4 - 2i)}
{4e^{i\pi/4} \cdot z + (9 - 4i)}.
\]
