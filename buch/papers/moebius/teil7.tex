...
\textbf{Möbius-Transformationen auf der reellen Achse}
...
\textbf{Interpretation der Parameter:}
...
\textbf{Wichtige Eigenschaft:}

Alle Punkte bleiben auf der reellen Achse, das heißt:
\[
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{papers/moebius/bild10.pdf}
	\caption{Spezialfall reelle Zahlen}
\end{figure}
...
Für große Beträge von \(x\) nähert sich der Funktionsgraph der horizontalen Asymptote \(y = \frac{a}{c}\).
