...
\textbf{Das bedeutet geometrisch:}
\begin{itemize}
	\item Punkte nahe bei \(0\) werden weit nach außen abgebildet  
	\item Große Abstände werden klein  
...
Mit den Eigenschaften des Betrags:
\[
\frac{|1 - w|}{|w|} = 1.
\]
