...
Man verbindet den Punkt \(z\) in der Ebene mit dem Nordpol. Der Schnittpunkt dieser Geraden mit der Kugel ist das Bild von \(z\) \cite{moebius:Moebiustransformationen}.
\begin{figure}
	\centering
