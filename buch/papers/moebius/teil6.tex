...
\textbf{Die Riemannsche Zahlenkugel}

Die riemannsche Zahlenkugel dient dazu, die komplexe Ebene um einen zusätzlichen Punkt
\(\infty\) zu erweitern. Diese Erweiterung nennt man die \textbf{erweiterte komplexe Ebene}:
\[
...
\frac{1}{0}
\]
sinnvoll zu interpretieren, indem man definiert:
\[
\frac{1}{0} = \infty.
\]
...
An dieser Stelle wird der Funktionswert in der erweiterten komplexen Ebene definiert als
\[
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{papers/moebius/bild8.pdf}
	\caption{Stereographische Projektion einer Geraden}
\end{figure}

\medskip

\textbf{Geraden und Kreise:}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{papers/moebius/bild9.pdf}
	\caption{Stereographische Projektion eines Kreises}
\end{figure}

\medskip

\textbf{Intuitive Vorstellung:}

 Man kann sich die riemannsche Zahlenkugel wie eine Weltkugel vorstellen.
 In der ebenen Darstellung (wie auf einer Landkarte) erscheinen große Kreise oft als Geraden.
 Betrachtet man jedoch die Kugel selbst, erkennt man, dass es sich in Wirklichkeit immer um Kreise handelt.
 
 Die scheinbare Unterscheidung zwischen Geraden und Kreisen in der Ebene ist daher nur eine Folge der Projektion.
