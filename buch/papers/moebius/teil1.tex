...
\]
kann als Verkettung von Translation, Drehstreckung und Inversion verstanden werden.
\[ad - bc \neq 0\]
...
\begin{itemize}
	\item \emph{Injektiv:} Verschiedene Punkte der Definitionsmenge werden auf verschiedene Punkte abgebildet.
	\item \emph{Surjektiv:} Jeder Punkt der Zielmenge wird von mindestens einem Punkt der Definitionsmenge getroffen.
\end{itemize}
