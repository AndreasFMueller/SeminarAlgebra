...
\begin{equation}
	f(z) = 2 + \frac{1}{z + 1}.
\end{equation}
Die Formel (24.1) kann als Schrittweise zerlegung der Möbius Transformation interpretiert werden.
...
z_2 = \frac{1}{z_1}.
\]
Punkte nahe beim Ursprung werden nach außen abgebildet und umgekehrt.
Abschliessend erfolgt eine weitere Verschiebung um \(2\) nach rechts
\[
f(z) = 2 + z_2.
\]
Somit ergibt sich insgesamt die Transformation von Formel (24.1).
\begin{figure}
	\centering
	\includegraphics[width=1\textwidth]{papers/moebius/bild6.pdf}
	\caption{Kombination der Translationen}
\end{figure} 
In der Abbildung 24.6 sieht man gut, wie (a) unsere Startgerade ist, bei (b) die Verschiebung um 1, bei (c) die Inversion von der Gerade zum Kreis, weil die Gerade nicht durch den Nullpunkt geht und bei (d) nochmals eine Verschiebung um 2 stattfindet.
\end{beispiel}
