...
% Kurz und anschaulich zeigen, wie Bessel von der Himmelsmechanik zu
% seinen Funktionen kam. Die Integraldarstellung aus teil3 ist die
% Brücke, mehr Theorie braucht es nicht.
%
...
\frac{2}{n\pi}
\int_0^\pi
\Bigl(\frac{dE}{dM}-1\Bigr)\cos nM\,dM
\\
&=
\frac{2}{n\pi}
\int_0^\pi
...
Die Reihe konvergiert für jede Exzentrizität $\varepsilon<1$, also für jede Ellipsenbahn, für $\varepsilon$ nahe bei $1$ allerdings langsam.
Wie langsam, zeigen die gestrichelte und die gepunktete Kurve in Abbildung~\ref{bessel:kepler:fig:reihe}.
...
Das ist bemerkenswert, denn die Entwicklung von $E$ nach Potenzen von $\varepsilon$ konvergiert nur für $\varepsilon<0.6627$.
% [TODO: Beleg für die Konvergenz und die Laplace-Grenze bei Watson nachschlagen und zitieren]
