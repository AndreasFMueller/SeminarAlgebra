...
Singularität an einem Punkt $x_0$ (z.~B.~\smash{$\int_{a}^{b} \frac{1}{x}\,dx$}). Da das
...
\begin{lemma}[kleiner Kreisbogen]
\index{Lemma!vom kleinen Kreisbogen}%
...
\begin{equation}
  f(z) = \frac{\res(x_0;f)}{z - x_0}
       + \underbrace{g(z)}_{\text{Taylor-Reihe}}
...
\index{Hauptwertformel}%
\index{Satz!Hauptwertformel}%
