...
Nähert man sich der Polstelle jedoch symmetrisch,
das heisst mit einem gemeinsamen $\epsilon$ und symmetrischen Grenzen $\pm R$,
so heben sich die beiden Beiträge wegen der Punktsymmetrie des Integranden
für jedes $\epsilon > 0$ und $R > \epsilon$ exakt auf:
\begin{equation}
...
Diese Idee, die Polstelle symmetrisch auszuschneiden,
führt auf den Begriff des Cauchy-Hauptwerts.
