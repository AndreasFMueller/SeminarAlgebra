...
\kopfrechts{Motivation und Definition}
...
genauso gegen $-\infty$.
Insgesamt treten vier voneinander unabhängige Grenzwerte auf.
Die Aufteilung \eqref{hauptwert:equation:aufteilung} führt somit auf den
...
Die zugrunde liegende Idee des Cauchy-Hauptwerts ist, dass
\index{Hauptwert}%
...
\eqref{hauptwert:equation:symmetrisch} ist
\[
...
\begin{equation}
  \begin{aligned}
    ...
    &= -\ln 2,
  \end{aligned}
  \label{hauptwert:equation:unsymmetrisch}
\end{equation}
