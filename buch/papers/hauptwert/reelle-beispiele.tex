...
Das uneigentliche Integral existiert daher nicht.
Der Integrand ist zwar nicht ungerade, er zerfällt aber in den ungeraden
Anteil $\frac{x}{1 + x^2}$, dessen Beiträge sich bei symmetrischer
Annäherung wegheben, und den geraden Anteil $\frac{1}{1 + x^2}$, dessen
Integral konvergiert.
Die symmetrische Annäherung nach Cauchy liefert deshalb den Hauptwert
\begin{equation}
\begin{aligned}
