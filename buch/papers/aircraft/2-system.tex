...
Um den Zustand der Seitenbewegung zu beschreiben, genügen vier Grössen.
Der \emph{Schiebewinkel} $\beta$ formalisiert das Schieben aus
Abschnitt~\ref{aircraft:subsection:dutchroll}:
Er misst den horizontalen Winkel zwischen der Längsachse und der tatsächlichen
...
\index{aerodynamische Derivative}%
\index{stability derivatives}%
