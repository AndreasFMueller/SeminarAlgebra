...
\input{papers/aircraft/videoqrcode.tex}
...
Auch die \emph{Spiralbewegung} (spiral mode) verläuft ohne Schwingung.
\index{Spiralbewegung}%
\index{spiral mode}%
...
Dafür brauchen wir mess- und berechenbare Grössen, die die Bewegung beschreiben.
