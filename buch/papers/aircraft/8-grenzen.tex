...
\index{Gierdampfer@Gierdämpfer}%
Gierrate $r$ misst und das Seitenruder proportional dazu betätigt, so dass
...
In der Sprache von Abschnitt~\ref{aircraft:subsection:realteil-imaginaerteil}
wird der Realteil $\sigma$ kleiner, und die Störung klingt schneller ab.
...
\index{Stabilitatsaugmentation@Stabilitätsaugmentation}%
...
deutlich reduziert \cite{aircraft:sadraey}.
