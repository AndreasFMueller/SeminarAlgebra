...
\begin{equation}
    ...
    =
    \begin{pmatrix*}[r]
    -0.254            &  0\phantom{.000} & -1.0\phantom{00} & 0.182           \\
    -16.02\phantom{0} & -8.40\phantom{0} &  2.19\phantom{0} & 0\phantom{.000} \\
     4.488            & -0.350           & -0.760           & 0\phantom{.000} \\
     0\phantom{.000}  &  1\phantom{.000} &  0\phantom{.000} & 0\phantom{.000}
    \end{pmatrix*}.
...
Nach Abschnitt~\ref{aircraft:subsection:eigenwertpaar} besteht die
...
Abschnitt~\ref{aircraft:subsection:systemmatrix}, das ist die Dutch Roll.
...
Die Spiralbewegung braucht dafür über eine Minute.
...
\label{aircraft:subsection:businessjet}}
...
\begin{equation}
    ...
    =
    \begin{pmatrix*}[r]
        -0.1567           &  0\phantom{.0000} & -1\phantom{.0000} & 0.0958 \\
        -2.408\phantom{0} & -1.1616           &  0.2501           & 0\phantom{.0000}      \\
        1.9011            &  0.0566           & -0.1079           & 0\phantom{.0000}      \\
        0\phantom{.0000}  &  1\phantom{.0000} &  0\phantom{.0000} & 0\phantom{.0000}
    \end{pmatrix*}.
...
Nach Nelson~\cite[Abschnitt 5.1]{aircraft:nelson} verläuft die
Spiralbewegung so allmählich, dass der Pilot sie unbewusst korrigiert.
...
Diese Korrektur setzt voraus, dass der Pilot die Lageänderung gegenüber dem
Horizont feststellt.
Im \emph{Instrumentenflug} (instrument flight) mit wenig oder keiner
\index{Instrumentenflug}%
Sichtreferenz kann der Pilot den Rollwinkel nur anhand der
Instrumentenanzeige erkennen.
Bleibt der Rollwinkel unbemerkt, so wächst er weiter, und das
Flugzeug dreht in eine immer engere Kurve.
Dabei senkt sich die Nase, und die Geschwindigkeit nimmt im Sinkflug
rasch zu.
Diese Bewegung heisst \emph{Spiralsturz} (spiral dive).
\index{Spiralsturz}%
Greift der Pilot nicht ein, so kann das Überschreiten der strukturellen
Betriebsgrenzen des Flugzeugs oder die Kollision mit dem Gelände die Folge sein.
...
\label{aircraft:subsection:vergleich}}
...
\begin{table}
    ...
    \begin{tabular}{llrrrr}
        ...
        & $-8.433\phantom{00}$           & --      & --    & $0.08$ \\
        & Spiralbewegung
        & $-0.00891$         & --      & --    & $78\phantom{.00}$   \\
        & Dutch Roll
        & $-0.486\phantom{00}$           & $2.334$ & $2.7$ & $1.4\phantom{0}$  \\
        \hline
        Business Jet      & Rollbewegung
        & $-1.203\phantom{00}$           & --      & --    & $0.6\phantom{0}$  \\
        & Spiralbewegung
        & $+0.00883$         & --      & --    & $-78\phantom{.00}$  \\
        & Dutch Roll
        & $-0.116\phantom{00}$           & $1.390$ & $4.5$ & $6.0\phantom{0}$  \\
        \hline
    \end{tabular}
...
\input{papers/aircraft/fig/fig-komplexe-ebene}
