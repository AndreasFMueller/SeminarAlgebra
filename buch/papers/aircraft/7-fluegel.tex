...
Abschnitt~\ref{aircraft:section:6-rechenbeispiel} haben dieselbe Form.
...
Gleichung~\eqref{aircraft:eqn:eigenwerte-ga} negativ, wie es die Bedingung
verlangt.
...
Der Vergleich in Abschnitt~\ref{aircraft:subsection:vergleich} ist mit diesem
...
als die des Propellerflugzeugs mit $\sigma = -0.486$.
