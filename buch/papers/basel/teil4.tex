...
\smallskip
Abbildung 10.1: Periodische Fortsetzung von $f(x) = x^2$ mit den Fourierpolynomen
$F_0$ bis $F_3$.
\end{center}
...
\smallskip
Abbildung 10.6: Im Punkt $\pi$ liegt Konvergenz gegen den Funktionswert $\pi^2$ vor.
\end{center}
