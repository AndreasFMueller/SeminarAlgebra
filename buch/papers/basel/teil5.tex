...
\node[left=6pt]        at (0.9, 1.4)   {$b$};
\node[right=6pt]       at (3.4, 1.4)   {$a$};
\node[below=8pt]       at (2.5, 0)     {$c$};
\node[right=6pt]       at (1.8, 1.4)   {$h$};
% Gleichung unterhalb des Dreiecks, klar getrennt
\node[below=18pt] at (2.5, 0) {$\dfrac{1}{2}\,c\,h \;=\; \dfrac{1}{2}\,a\,b$};
\end{tikzpicture}
...
Die zentrale Idee des Beweises ist, dass sich bei jedem Konstruktionsschritt
alle folgenden Intensitäten auf neue Punkte übertragen,
die Gesamtsumme also stets erhalten bleibt.
