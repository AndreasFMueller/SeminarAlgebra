...
Bei der finiten Differenzenmethode wird die Ableitung über den Quotienten
\begin{equation*}
...
Bei den dualen Zahlen entspricht dies der exakten Fortsetzung der Taylorentwicklung bis zur ersten Ordnung, da höhere Terme aufgrund $\epsilon^2 = 0$ verschwinden.
Bei der Complex-Step-Differentiation basiert der Zugang auf der holomorphen Fortsetzbarkeit reell-analytischer Funktionen, deren Taylorentwicklung im komplexen Bereich gültig ist.

Die Gemeinsamkeit beider Verfahren lässt sich daher als Ausnutzung der Taylorstruktur interpretieren:
...
Die Python-Implementierung der dualen Zahlen macht diesen Mechanismus besonders deutlich:
