...
Sei dazu $\epsilon \neq 0$ ein nilpotentes Element, d.h ein Element, für das $\epsilon^2 = 0$ postuliert wird \cite{step:baydin2018}. Dann gilt insbesondere
...
Auf den ersten Blick scheint sich der Ausdruck in Gleichung\,\ref{step:taylorepsilon} kaum von der finiten Differenz in \ref{step:taylor2} zu unterscheiden.
...
Wird eine Grösse zusammen mit ihrer Ableitung als duale Zahl $(u,u')$ dargestellt, so liefert jede der oben definierten Operationen in ihrer ersten Komponente den zugehörigen Funktionswert und in ihrer zweiten Komponente dessen Ableitung.
