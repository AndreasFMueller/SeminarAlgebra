...
Als Pendant zur Vorwärtsdifferenz lässt sich auch die \emph{Rückwärtsdifferenz} bilden, indem $h<0$ gewählt wird:

\begin{equation*}
	f'\left(x\right) \approx \frac{f\left(x\right) - f\left(x-h\right)}{h},
	\label{step:diffmethod}
\end{equation*}
wobei auch diese Approximation einen Fehler erster Ordnung von $O(h)$ aufweist.
...
\begin{figure}[h!] %todo
	\centering
	\includegraphics[width=0.8\textwidth]{../../code/finite_differenzen_vergleich.png}
...
\begin{figure}[h!] %todo
	\centering
	\includegraphics[width=0.8\textwidth]{../../code/dritte_ableitung_vergleich.png}
