...
Die Berechnung des grössten gemeinsamen Teilers von \(a(X)\) und \(b(X)\) mit \(n = \deg a \geq m = \deg b\) in der Tableau-Methode beginnt mit der Sylvester-Matrix \(\operatorname{Syl}(b,a)\).
...
In der rechten unteren Ecke ist nun eine kleinere Sylvester-Matrix \(\operatorname{Syl}(b,r)\) entstanden.
...
\end{satz}
\begin{definition}
    (Resultante). Wie bereits in Einleitung (\ref{resultante:equation:definition}) geschrieben. Sind \(f\) und \(g\) Polynome, dann heisst die Determinante der Sylvester-Matrix
    \begin{equation*}
