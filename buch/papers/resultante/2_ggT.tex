    ...
    \begin{equation}
        ...
        \CodeAfter
            \tikz {
                ...
                \draw[dashed] ([xshift=1pt]3-|3) -- ([xshift=1pt]6-|3);
...
Der Algorithmus zur Berechnung der Determinante endet sobald der grüne Rest \(=0\) ist oder im braunen Feld (mit dem \(?\)) eine Zahl steht bleibt.
