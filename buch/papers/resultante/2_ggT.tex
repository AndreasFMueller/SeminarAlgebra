...
Das ist die Matrix \ref{resultante:equation:Syldef} in der alle \(m\)-Zeilen des \(a(X)\) Polynoms mit denen des \(b(x)\) Polynoms vertauscht werden.
...
\begin{beispiel}
    ...
    \begin{equation}
        ...
        \CodeAfter
            \tikz {
                \draw ([xshift=-3pt,yshift=1pt]1-|1) rectangle ([xshift=3pt,yshift=-1pt]8-|8);
                \draw[dashed] ([xshift=-3pt,yshift=1pt]5-|1) -- ([xshift=3pt,yshift=1pt]5-|8);
            }
        \end{NiceArray}
        \,\,\to\,\,
        \begin{NiceArray}{*{7}{c}}
    ...
    \begin{equation}
        ...
        \CodeAfter
            \tikz {
                \draw ([xshift=-3pt,yshift=1pt]1-|1) rectangle ([xshift=3pt,yshift=-1pt]6-|6);
                \draw[dashed] ([xshift=-3pt,yshift=1pt]4-|1) -- ([xshift=3pt,yshift=1pt]4-|6);
            }
        \end{NiceArray}
        \,\,\to\,\,
        \begin{NiceArray}{*{5}{c}}
        ...
        \CodeAfter
            \tikz {
            %   \draw ([xshift=-3pt,yshift=1pt]1-|1) rectangle ([xshift=3pt,yshift=-1pt]6-|6);
            %   \draw[dashed] ([xshift=3pt,yshift=1pt]3-|3) -- ([xshift=3pt,yshift=-1pt]6-|3);
            %   \draw[dashed] ([xshift=3pt,yshift=1pt]3-|3) -- ([xshift=3pt,yshift=1pt]3-|6);
            %   \draw[dashed] ([xshift=-3pt,yshift=1pt]4-|1) -- ([xshift=3pt,yshift=1pt]4-|8);
            }
        \end{NiceArray}\,\,\,.
    ...
    \begin{equation}
        ...
        \CodeAfter
            \tikz {
              ...
              \draw[dashed] ([xshift=3pt,yshift=1pt]3-|3) -- ([xshift=3pt,yshift=-1pt]4-|3);
              \draw[dashed] ([xshift=-3pt,yshift=1pt]3-|1) -- ([xshift=3pt,yshift=1pt]3-|4);
            }
        \end{NiceArray}\,\,\,.
...
Ausserdem können weitere Zeilenoperationen eingespart werden, in dem nur die erste Zeile des Restes berechnet wird und auf den darunter liegenden Zeilen kopiert wird.
...
Der Algorithmus zur Berechnung der Determinante endet sobald der grüne Rest \(=0\) ist oder im braunen Feld eine Zahl \(\neq0\) steht bleibt.
Ist der Rest \(=0\) ist in der darüber liegenden Zeile der grösste gemeinsame Teiler in Polynom vom Grad \(\geq1\):
