...
Dieser wird in der PRS mit der Brown-Normierung festgelet.
...
\begin{beispiel}
    ...
    Nun kann der \(\ggt\) mit der darüber liegenden Zeile bestimmte werden, für \(c_1=1\):
    \begin{equation}
        \begin{aligned}
    ...
    \end{equation}
    hier ist es besonders da \(G_3\) ebenfalls null wird, muss wiederum in der darüberliegenden Zeile geschaut werden.
    \begin{equation}
        \begin{aligned}
...
\end{beispiel}
Das Beispiel \ref{resultante:beispiel:subprsRT} zeigt, es gibt viele verschiedene Wege die Resultante zu berechnen.