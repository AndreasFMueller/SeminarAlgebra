...
\end{align*}
Der Pol $z_-$ liegt also für alle Werte von $\varepsilon$ ausserhalb des Einheitskreises.
...
\lim_{\varepsilon \to 1^-} z_+ &= \lim_{\varepsilon \to 1^-} \biggl(-\frac{1}{\varepsilon}+\sqrt{\frac{1}{\varepsilon^2}-1}\biggr) = -1.
\end{align*}
Wie wir sehen, liegt der Pol $z_+$ für alle Werte von $\varepsilon$ innerhalb des Einheitskreises.
