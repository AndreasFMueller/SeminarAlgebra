...
\]
Nun ersetzen wir den Drehimpuls mit der Beziehung \eqref{kepler:eqn:drehimpulsgeometrie} durch $L=m\sqrt{GMp}$.
...
Der Integralansatz führt für $E=0$ also auf dieselbe Konstante wie das Kräftegleichgewicht.
