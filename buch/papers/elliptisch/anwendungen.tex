...
\input{papers/elliptisch/fig/troposkeinFIG.tex}%
...
Wir machen den Ansatz, mit $x$ von $A$ aus gemessen,
\begin{equation}
y(x)
=
...
grösste Auslenkung in der Mitte, also ist der Achsenabstand
...
\input{papers/elliptisch/fig/pendelFIG.tex}%
...
\cite[Kapitel~11.2.3]{elliptisch:mueller-spezielle}.
