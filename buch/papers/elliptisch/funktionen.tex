...
Im vorherigen Abschnitt wurde dem Ellipsenintegral \eqref{elliptisch:equation:umfang}
ein Namen gegeben.
...
\cite[Abschnitt~164, S.~506]{elliptisch:smirnow} \cite{elliptisch:mueller-spezielle}.
...
lässt sich also auch über dem gemeinsamen Nenner schreiben,
\begin{equation}
...
\input{papers/elliptisch/fig/ke-plotFIG.tex}
...
\end{equation}
\input{papers/elliptisch/fig/sn-konstruktionFIG.tex}
...
\cite[Kapitel~11.2.2]{elliptisch:mueller-spezielle}.
...
= \operatorname{sech} u$
\cite[Kapitel~11.2.1]{elliptisch:mueller-spezielle}.
...
\cite[Kapitel~11.2, Tabelle~11.3]{elliptisch:mueller-spezielle}.
Wir brauchen sie im Weiteren nicht.
