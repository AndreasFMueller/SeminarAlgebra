...
\draw[orange, thin] (0,0) -- (\px,0);
\node[orange, below=0.1pt, inner sep=0.5pt] at ({\px/2},0)
...
% sn(u,k)
\draw[dashed, thin, darkgreen] (\px,0) -- (\px,\sq)
	node[midway, sloped, below=0.1pt, inner sep=0.5pt]
	{$\operatorname{sn}(u,k)$};

% cn(u,k)
\draw[dashed, thin, darkblue] (0,\sq) -- (\cq,\sq)
...
\node[darkred, anchor=south west] at ($(0,0)!1.3!(\px,\sq)$)
