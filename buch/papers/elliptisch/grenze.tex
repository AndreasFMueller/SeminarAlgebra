...
\todo{Vorzeichen falsch, Plus statt Minus. Fehler auch bei Müller?}
...
Wegen $dx = -du/u^2$ und
\begin{equation}
p\Bigl(\alpha+\frac{1}{u}\Bigr)
=
\frac{1}{u}\,q\Bigl(\alpha+\frac{1}{u}\Bigr)
=
\frac{Q(u)}{u^4},
\qquad
Q(u) = u^3\,q\Bigl(\alpha+\frac{1}{u}\Bigr),
...
zusammen.
\input{papers/elliptisch/fig/gradskalaFIG.tex}
